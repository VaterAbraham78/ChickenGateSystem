...
/***	Korrekturversion: V28		- im Code nachtragen		***/
/***															***/
/***															***/
...
const char NEX_NAME_ACTREVISION[] = "pMain.t003";				// Name der Hilfsvariable "Revisionsbezeichnung" (z.B. "F05")

const char REVISION_SCHEMA = 'E';								// Aktuelle Schema-Revision	(Buchstabe, manuell nachfuehren)
const byte REVISION_CODE = 28;									// Aktuelle Code-Revision 	(Zahl 0-99, manuell nachfuehren)	
